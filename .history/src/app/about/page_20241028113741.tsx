      ...
      <div className="container pt-8">
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="space-y-4">
            ...
            At , we’re more than a makeup brand; we’re a passionate team of innovators, artists, and beauty advocates with a shared vision—to redefine beauty standards and inspire self-confidence in everyone. Our brand was born out of a desire to create products that not only enhance but celebrate individuality.
