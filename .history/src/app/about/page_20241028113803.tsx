...
What drives us? Seeing you glow. We believe that makeup should be fun, empowering, and true to you.
        ...
        <div className="grid md:grid-cols-2 gap-16 pt-8">
          <div className="space-y-4 order-last md:order-first">
            ...
            <p className='text-xl text-justify'>
            Welcome to D & , where beauty meets creativity, and every shade tells a story. Our journey began with a passion for empowering individuals to feel confident, bold, and unapologetically themselves. We believe that makeup is more than just a routine—it's a powerful tool for self-expression and a celebration of uniqueness.
